...
# i.e. multiplying by DigDecimal's unit can be viewed as an alternative way of casting Float into Decimal;
# or simply one could expect that BigDecimal#* should always invoke Float#to_d on it's argument.
